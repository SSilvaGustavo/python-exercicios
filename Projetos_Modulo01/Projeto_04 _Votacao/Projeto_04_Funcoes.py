...
class Funcoes:
    def __init__(self): #Iniciando o metodos que vao ser usados
        self.__cand1 = str(input("Digite o nome do primeiro canditado: ")).upper().strip() # cand = Candidatos que o usuario quer colocar
        self.__cand2 = str(input("Digite o nome do segundo canditado: ")).upper().strip()
        self.__cand3 = str(input("Digite o nome do terceiro canditado: ")).upper().strip()
